...
namespace CompanyTask.Presentation.Areas.CompanyManager.Controllers
{
    ...
    public class CompanyController : Controller
    {
        ...
        public CompanyController(IPersonelService personelService, ICompanyManagerService companyManagerService, IAddressService addressService, IAccountService accountService)
        {
